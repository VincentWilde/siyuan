...
import (
	...
	"fmt"
	"net/http"
	// "os"  // PRIVACY-PRO: Commented out - unused after disabling refreshAnnouncement
	// "path/filepath"  // PRIVACY-PRO: Commented out - unused after disabling refreshAnnouncement
	"regexp"
	"strconv"
	"strings"
	"time"
...
func RefreshCheckJob() {
	...
	// No subscription checks, user refresh, announcements, or update checks
	return
...
func refreshUser() {
	...
	// No HTTP calls to refresh user data
	return
...
func refreshAnnouncement() {
	...
	// No HTTP calls to fetch announcements
	return
