...
func StartCron() {
	...
	// Disabled for security: go every(6*time.Hour, util.RefreshRhyResultJob, "RefreshRhyResultJob")
	// Disabled for security: go every(2*time.Hour, model.RefreshCheckJob)
